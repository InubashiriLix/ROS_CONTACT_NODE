...
uint8_t CommPort::get_rx_is_self_team_red() { return this->rx_struct_.is_self_team_red; }
...
uint8_t CommPort::get_rx_camera_id() { return this->rx_struct_.camera_id; }

uint8_t CommPort::get_rx_crc8_check_sum() { return this->rx_struct_.crc8_check_sum; }
...
void CommPort::set_tx_yaw_angle(float new_yaw_angle) { this->tx_struct_.yaw_angle = new_yaw_angle; }

void CommPort::set_tx_checksum(uint8_t new_checksum) { this->tx_struct_.checksum = new_checksum; }
