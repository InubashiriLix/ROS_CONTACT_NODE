...
public:
  ...
  void rx_timer_callback() {
    ...
    RCLCPP_INFO(this->get_logger(), "Color: %d",
                comm.get_rx_is_self_team_red());
    ...
    // TODO: buller speed
    RCLCPP_INFO(this->get_logger(), "Buller Speed: %f",
                comm.get_rx_buller_speed());
  }
